...
----------------------------------------------------------------------
File    : RTOSInit_AT91SAM9260.c for ATMEL AT91SAM9260 CPU
...
*/
#define OS_FSYS (158515200uL)   // Usage of EMAC limits the AHB frequency to 160 MHz
...
*
* NOTES: (1) Settings used here are for AT91SAM9260-EK eval board
...
/********************************************************************/
  ...
  unsigned int TranslationTable[0x1000] __attribute__ ((aligned (16384), section (".no_init")));
#endif
...
OS_INTERWORK int __low_level_init(void) {
  ...
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_NC_NB,   0x000, 0x000, 0x001);    // Internal SRAM0, remapped, cacheable, bufferable
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_NC_NB,   0x002, 0x002, 0x001);    // Internal SRAM0, original address, non-cacheable, non-bufferable
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_NC_NB,   0x003, 0x003, 0x001);    // Internal SRAM1, NON cacheable, NON bufferable
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_C_B,     0x200, 0x200, 0x040);    // SDRAM, 64MB, cacheable, bufferable
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_NC_NB,   0x240, 0x200, 0x040);    // SDRAM, 64MB, NON cacheable, NON bufferable, same physical address cacheable SDRAM
  ...
  OS_ARM_MMU_AddTTEntries(&TranslationTable[0], OS_ARM_CACHEMODE_NC_NB,   0xfff, 0xfff, 0x001);    // SFR area NON cacheable, NON bufferable
