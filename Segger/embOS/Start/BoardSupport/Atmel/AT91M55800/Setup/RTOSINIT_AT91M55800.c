...
#define __USART0_BASE_ADDR   (0xfffc0000)
#define __USART1_BASE_ADDR   (0xfffc4000)
#define __USART2_BASE_ADDR   (0xfffc8000)
...
*/
#define OS_TIMER_RELOAD (OS_PCLK_TIMER/OS_TIMER_PRESCALE/OS_TICK_FREQ)
...
*/
  ...
  #define US_CR   (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_CR_OFFS))
  #define US_MR   (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_MR_OFFS))
  #define US_IER  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_IER_OFFS))
  #define US_IDR  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_IDR_OFFS))
  #define US_IMR  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_IMR_OFFS))
  #define US_CSR  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_CSR_OFFS))
  #define US_RHR  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_RHR_OFFS))
  #define US_THR  (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_THR_OFFS))
  #define US_BRGR (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_BRGR_OFFS))
  #define US_RTOR (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_RTOR_OFFS))
  #define US_TTGR (*(volatile OS_U32*)(OS_UART_BASE_ADDR + __USART_TIGR_OFFS))
...
void OS_COM_Init(void) {         // Initialize UART, enable UART interrupts
  ...
  __AIC_ICCR = (1 << OS_UART_ID);                           // Clear OS usart interrupt.
...
*   Used to initialize PLL and memory setup
*/
