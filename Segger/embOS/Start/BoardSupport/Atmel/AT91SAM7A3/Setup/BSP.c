...
----------------------------------------------------------------------
File    : BSP.c (for AT91SAM7A3 and IAR compiler)
Purpose : BSP for AT91SAM7Ae-EK
--------  END-OF-HEADER  ---------------------------------------------
*/
...
#define _LED0_BIT      (20) /* LED1 on SAM7A3-EK board active low */
#define _LED1_BIT      (21) /* LED2 on SAM7A3-EK board active low */
...
void BSP_SetLED(int Index) {
  _LEDPORT_CODR = (1 << (20 + Index));         /* Switch on LED 0  */
}

void BSP_ClrLED(int Index) {
  _LEDPORT_SODR = (1 << (20 + Index));         /* Switch off LED 0 */
}

void BSP_ToggleLED(int Index) {
  if (_LEDPORT_STATE & (1 << (20 + Index))) {  /* LED was off */
    BSP_SetLED(Index);
  } else {
    BSP_ClrLED(Index);
  }
