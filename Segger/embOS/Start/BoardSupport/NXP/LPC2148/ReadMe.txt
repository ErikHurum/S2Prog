Readme.txt for BSP for LPC2148

Supported hardware:
===================
The sample project for NXP LPC2148 is prepared
to run on an IAR LPC2148 Kickstart eval board,
...
- Debug_RAM:
  ...
  LPC2148_RAM.mac ensures that internal RAM
  is mapped at 0x00.
...
- Debug_FLASH:
  ...
  and CSpy.
  A call of LPC2148_FLASH.mac ensures that
...
- Release_FLASH:
  ...
  A call of LPC2148_FLASH.mac ensures that FLASH
  is mapped at 0x00.
