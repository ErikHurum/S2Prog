...
----------------------------------------------------------------------
File    : RTOSInit_LPC2106.c   (for Philips LPC2106 CPU)
...
#define _CRYSTAL_CLOCK 14745600L  /* external crystal frequency   */
#define OS_INIT_PLL 1             /* Init PLL during startup      */
...
static void _InitPLL(void) {
  _PLLCFG  =  (OS_PLL_MULTIPLIER - 1)    // => Multiplication value, defaul = 4
             |(0x01 << 5);               // => P Value = 2
