...
/* Mappings for multi layer configurations */
  ...
  #define SIM_WriteMem32p SIM_WriteMem32p_1
  #define SIM_ReadMem32p  SIM_ReadMem32p_1
  #define SIM_SetVRAMAddr SIM_SetVRAMAddr_1
  #define SIM_SetVRAMSize SIM_SetVRAMSize_1
#elif LCD_DISPLAY_INDEX == 2
  #define SIM_WriteMem32  SIM_WriteMem32_2
  #define SIM_ReadMem32   SIM_ReadMem32_2
  #define SIM_WriteMem32p SIM_WriteMem32p_2
  #define SIM_ReadMem32p  SIM_ReadMem32p_2
  #define SIM_SetVRAMAddr SIM_SetVRAMAddr_2
  #define SIM_SetVRAMSize SIM_SetVRAMSize_2
#elif LCD_DISPLAY_INDEX == 3
  #define SIM_WriteMem32  SIM_WriteMem32_3
  #define SIM_ReadMem32   SIM_ReadMem32_3
  #define SIM_WriteMem32p SIM_WriteMem32p_3
  #define SIM_ReadMem32p  SIM_ReadMem32p_3
  #define SIM_SetVRAMAddr SIM_SetVRAMAddr_3
  #define SIM_SetVRAMSize SIM_SetVRAMSize_3
#elif LCD_DISPLAY_INDEX == 4
  #define SIM_WriteMem32  SIM_WriteMem32_4
  #define SIM_ReadMem32   SIM_ReadMem32_4
  #define SIM_WriteMem32p SIM_WriteMem32p_4
  #define SIM_ReadMem32p  SIM_ReadMem32p_4
  #define SIM_SetVRAMAddr SIM_SetVRAMAddr_4
  #define SIM_SetVRAMSize SIM_SetVRAMSize_4
#elif LCD_DISPLAY_INDEX == 5
  #define SIM_WriteMem32  SIM_WriteMem32_5
  #define SIM_ReadMem32   SIM_ReadMem32_5
  #define SIM_WriteMem32p SIM_WriteMem32p_5
  #define SIM_ReadMem32p  SIM_ReadMem32p_5
  #define SIM_SetVRAMAddr SIM_SetVRAMAddr_5
  #define SIM_SetVRAMSize SIM_SetVRAMSize_5
#endif
  ...
  void LCDSIM_SetOrg(int x, int y, int Layer);
  #undef  LCD_SET_ORG
  #ifdef   LCD_READ_MEM
    #undef LCD_READ_MEM
  #endif
...
#else
  #ifndef   LCD_READ_MEM
    #define LCD_READ_MEM(Off)        (*((U32 *)_VRAMAddr + (U32)Off))
  #endif
  #ifndef   LCD_WRITE_MEM
    #define LCD_WRITE_MEM(Off, Data)  *((U32 *)_VRAMAddr+ (U32)Off) = Data
  #endif
  ...
  #define READ_MEM32P(p)        _Swap(LCD_READ_MEM32P(p))
  #define WRITE_MEM(Off, Data)  LCD_WRITE_MEM(Off, _Swap(Data))
  #define WRITE_MEM32P(p, Data) LCD_WRITE_MEM32P(p, _Swap(Data))
#else
...
#if (((_vxSizePhys * LCD_BITSPERPIXEL) / 32) * 32) != (_vxSizePhys * LCD_BITSPERPIXEL)
...
#define OFF2PTR(Off)     (U32 *)((U8 *)_VRAMAddr + Off * 4)
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 32, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#if (LCD_ENDIAN_BIG == 0)    && \
    (LCD_BITSPERPIXEL == 32) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
  ...
  case 0:
    {
      ...
      Odd = x & 3;
      if (Odd) {                    
        Data    = READ_MEM(Off);    /* Read DWord 0 */
        switch (Odd) {
        case 1:                     /* Pixel 1 */
        ...
        case 3:                     /* Pixel 3 */
          ...
          Data &= 0x000000FF;
          Data |= Index << 8;       /* Write Pixel 3, Byte 0 - 2 into DWord 2 */
          xsize--;                  /* Pixel processed */
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_MIRROR_X == 1, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0)    && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_MIRROR_X == 1) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0)    && \
    (LCD_BITSPERPIXEL == 16) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_MIRROR_X == 1, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0)    && \
    (LCD_BITSPERPIXEL == 16) && \
    (LCD_MIRROR_X == 1) && \
  ...
  case 0:
    {
      ...
      if (xsize >= 2) {
        do {
          ...
          Color     = (Pixels & 1 ? Index1 : Index0) << 16;
          Color    |=  Pixels & 2 ? Index1 : Index0;
          Pixels  >>= 2;
          PixelCnt -= 2;
          WRITE_MEM(Off, Color);
          Off--;
  ...
  case LCD_DRAWMODE_TRANS:
    {
      U32 Data;
      unsigned PixelPos;
      unsigned Pixels, PixelCnt, Off, xx;
      #if (LCD_MIRROR_Y == 1)
        y = _vySize - y - 1;
      #endif
      PixelCnt = 8 - Diff;
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 8, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 8) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 4, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 4) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 2, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 2) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 1 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 1, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 1) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 4 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 4, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
...
/*********************************************************************
*
*       Draw Bitmap 8 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 8, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
...
/*********************************************************************
*
*       Draw Bitmap 8 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 8, LCD_SWAP_XY == 1, LCD_MIRROR_X == 1
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 8) && \
    (LCD_MIRROR_X == 1) && \
...
/*********************************************************************
*
*       Draw Bitmap 8 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 4, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 4) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 8 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 2, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 2) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 8 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 1, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 1) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 16 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_MIRROR_X == 0, LCD_MIRROR_Y == 0, LCD_SWAP_XY == 0
*/
...
/*********************************************************************
*
*       Draw Bitmap 16 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_MIRROR_X == 1, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 16) && \
    (LCD_MIRROR_X == 1) && \
...
/*********************************************************************
*
*       Draw Bitmap 32 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 32, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#if (LCD_BITSPERPIXEL > 16)
#if (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 32) && \
...
/*********************************************************************
*
*       Draw Bitmap 32 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       Draw Bitmap 32 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_MIRROR_X == 1, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_MIRROR_X == 1) && \
...
/*********************************************************************
*
*       Draw Bitmap 32 BPP, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_SWAP_XY == 1, LCD_MIRROR_X == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_MIRROR_X == 0) && \
    (LCD_SWAP_XY == 1)
static void _DrawBitLine32BPP_Swap(unsigned x, unsigned y, U32 const GUI_UNI_PTR * pData, int ysize, int BytesPerLine, U8 Pos) {
  #define GET_PIXEL_INDEX(Index) \
    Index = (*pData) & 0xFFFFFF; \
    pData += DWordsPerLine
  U32 Data, Index;
  unsigned Off, Odd, DWordsPerLine, x0, y0;
  #if (LCD_MIRROR_Y == 1)
    y0 = _vxSize - x - 1;
  #else
    y0 = x;
...
#if (LCD_BITSPERPIXEL == 32) || (LCD_BITSPERPIXEL == 24)
  #if LCD_ALLOW_NON_OPTIMIZED_MODE == 0
    #error Non-optimized mode. Please select an other mode, define LCD_ALLOW_NON_OPTIMIZED_MODE in LCDCOnf.h or contact support.
  #endif
#endif
...
/*********************************************************************
*
*       _ReadRect, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_MIRROR_X == 0, LCD_MIRROR_Y == 0, LCD_SWAP_XY == 0
*/
#if (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 16) && \
    (LCD_MIRROR_X == 0) && \
...
static void _ReadRect(int x0, int y0, int x1, int y1, LCD_PIXELINDEX * pBuffer) {
  ...
  do {
    ...
    for (;x1Phys > x0Phys; x1Phys -= 2, Off--, p += 2) {
      Data = READ_MEM(Off);
      *(p    ) = Data >> 16;
      *(p + 1) = Data & 0xffff;
    }
...
void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex) {
  ...
  #if (LCD_SWAP_XY == 1) | (LCD_MIRROR_X == 1) | (LCD_MIRROR_Y == 1)
...
unsigned int LCD_L0_GetPixelIndex(int x, int y) {
  ...
  /* Read from hardware */
  {
    ...
    #elif (LCD_ENDIAN_BIG == 0) && (LCD_BITSPERPIXEL == 16)
      PixelIndex = (U16)(Data >> (16 * PixelPos));
    #elif (LCD_ENDIAN_BIG == 1) && (LCD_BITSPERPIXEL == 16)
      PixelIndex = (U16)(Data >> (16 * (1 - PixelPos)));
    #elif (LCD_ENDIAN_BIG == 0) && (LCD_BITSPERPIXEL == 24)
      switch (xPhys & 3) {
      case 0:
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 32, LCD_SWAP_XY == 0
*/
#if (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 32) && \
    (LCD_SWAP_XY == 0)
  ...
  if (GUI_Context.DrawMode & LCD_DRAWMODE_XOR) {
    ...
    if (RemPixels >= 16) {
      ...
      do {
        ...
        WRITE_MEM32P(pDest +  1, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  2, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  3, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  4, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  5, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  6, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  7, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  8, LCD_COLORINDEX);
        WRITE_MEM32P(pDest +  9, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 10, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 11, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 12, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 13, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 14, LCD_COLORINDEX);
        WRITE_MEM32P(pDest + 15, LCD_COLORINDEX);
        pDest += 16;
        RemPixels -= 16;
      } while (RemPixels >= 0);
      RemPixels += 16;
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_SWAP_XY == 0)
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 16, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 16) && \
    (LCD_SWAP_XY == 0)
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 8, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
      (LCD_BITSPERPIXEL == 8) && \
      (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 4, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
      (LCD_BITSPERPIXEL == 4) && \
      (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 2, LCD_MIRROR_X == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
      (LCD_BITSPERPIXEL == 2) && \
      (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       LCD_L0_DrawHLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 1, LCD_MIRROR_X == 0, LCD_MIRROR_Y == 0, LCD_SWAP_XY == 0
*/
#elif (LCD_ENDIAN_BIG == 0) && \
      (LCD_BITSPERPIXEL == 1) && \
      (LCD_MIRROR_X == 0) && \
...
/*********************************************************************
*
*       LCD_L0_DrawVLine, optimized for LCD_ENDIAN_BIG == 0, LCD_BITSPERPIXEL == 24, LCD_SWAP_XY == 1
*/
#if (LCD_ENDIAN_BIG == 0) && \
    (LCD_BITSPERPIXEL == 24) && \
    (LCD_SWAP_XY == 1)
...
void LCD_L0_DrawVLine(int x, int y0,  int y1) {
  if (GUI_Context.DrawMode & LCD_DRAWMODE_XOR) {
    ...
    #if (LCD_MIRROR_X == 0) && (LCD_MIRROR_Y == 0) && (LCD_SWAP_XY == 0) && (LCD_BITSPERPIXEL != 24)
                       ...
                       const LCD_PIXELINDEX* pTrans)
{
  ...
  #if (LCD_BITSPERPIXEL > 16)
    case 32:
      #if (LCD_ENDIAN_BIG == 0) && (LCD_BITSPERPIXEL == 24) && (LCD_SWAP_XY == 1) && (LCD_MIRROR_X == 0)
        for (i = 0; i < xsize; i++) {
          _DrawBitLine32BPP_Swap(x0 + i, y0, (const U32 *)pData + i, ysize, BytesPerLine, i);
        }
      #else
        for (i = 0; i < ysize; i++) {
