...
*       _Color2Index_556
*/
static unsigned _Color2Index_556(LCD_COLOR Color) {
  int r, g, b;
...
*       _Index2Color_556
*/
static LCD_COLOR _Index2Color_556(unsigned Index) {
  unsigned int r, g, b;
  /* Separate the color masks */
  r = Index                        & R_MASK;
  g = (Index >> R_BITS)            & G_MASK;
  b = (Index >> (R_BITS + G_BITS)) & B_MASK;
...
*       _GetIndexMask_556
*/
static unsigned _GetIndexMask_556(void) {
  return 0xffff;
}
...
*/
const LCD_API_COLOR_CONV LCD_API_ColorConv_556 = {
  _Color2Index_556,
  _Index2Color_556,
  _GetIndexMask_556
};
