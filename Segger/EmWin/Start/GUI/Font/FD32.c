...
GUI_CONST_STORAGE U8 acFont32_Add[3*32] = {
   ________,________,________,
   ________,________,________,
   ________,________,________,
   ________,________,________,
...
GUI_CONST_STORAGE U8 acFont32_Sub[3*32] = {
   ________,________,________,
   ________,________,________,
   ________,________,________,
   ________,________,________,
...
GUI_CONST_STORAGE U8 acFont32[10][96] = {
{
...
GUI_CONST_STORAGE GUI_CHARINFO CharInfo32[] = {
  ...
  ,{ 24,24,3, acFont32_Add}		/* '+' */
  ,{ 24,24,3, acFont32_Sub}		/* '-' */
  ,{ 12,12,2, acFont32_DP} 		/* '.' */
...
GUI_CONST_STORAGE GUI_FONT_PROP FontProp32_3 = {
   48                         /* first character               */
  ,58                         /* last character                */
  ,&CharInfo32[4]             /* address of first character    */
...
GUI_CONST_STORAGE GUI_FONT_PROP FontProp32_2 = {
   45                         /* first character               */
  ,46                         /* last character                */
  ,&CharInfo32[2]             /* address of first character    */
...
GUI_CONST_STORAGE GUI_FONT_PROP FontProp32_1 = {
   43                         /* first character               */
  ,43                         /* last character                */
  ,&CharInfo32[1]             /* address of first character    */
