...
LCD_API_NEXT_PIXEL * LCD_GetNextPixelAPI(void) {
  ...
  if (GUI_Context.apDevice[GUI_Context.SelLayer]->pDeviceAPI->pfGetDevFunc) {
    pNextPixel_API = (LCD_API_NEXT_PIXEL *)GUI_Context.apDevice[GUI_Context.SelLayer]->pDeviceAPI->pfGetDevFunc(GUI_Context.apDevice[GUI_Context.SelLayer], LCD_DEVFUNC_NEXT_PIXEL);
  } else {
    pNextPixel_API = NULL;
  }
  /*
  ...
  */
  ...
  #else
  LCD_API_NEXT_PIXEL * pNextPixel_API;
  pNextPixel_API = (LCD_API_NEXT_PIXEL *)GUI_Context.pDeviceAPI->pfGetDevFunc(LCD_DEVFUNC_NEXT_PIXEL);
  if (!pNextPixel_API) {
    pNextPixel_API = &_NextPixel_API;
  }
  return pNextPixel_API;
