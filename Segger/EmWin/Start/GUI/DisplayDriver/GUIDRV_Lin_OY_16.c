...
static void _ReadRect(GUI_DEVICE * pDevice, int x0, int y0, int x1, int y1, LCD_PIXELINDEX * pBuffer) {
  ...
  // Mirror y
  //
  y0 = (pContext->vySize - 1 - y0);
  y1 = (pContext->vySize - 1 - y1);
  //
  p = (U16 *)pBuffer;
  x = x0;
  do {
...
void GUIDRV_Lin_OY_16_C(void);   // Avoid empty object files
void GUIDRV_Lin_OY_16_C(void) {}
