...
#define LOG2PHYS_Y(vxSize, vySize, x, y) vxSize - 1 - (x)
...
void GUIDRV_Lin_OSY_16_C(void);   // Avoid empty object files
void GUIDRV_Lin_OSY_16_C(void) {}
