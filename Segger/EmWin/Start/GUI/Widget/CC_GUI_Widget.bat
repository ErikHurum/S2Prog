...
ECHO CC_GUI_Widget.bat:        Compiling GUI\Widget

CALL CC BUTTON
CALL CC BUTTON_Bitmap
CALL CC BUTTON_BMP
CALL CC BUTTON_Color
...
CALL CC TREEVIEW
CALL CC TREEVIEW_CreateIndirect
CALL CC TREEVIEW_Default
CALL CC TREEVIEW_Image
CALL CC WIDGET
