...
**********************************************************************
*/
#define GUI_NUMBYTES   1000000 /* Available memory in bytes for emWin */
...
static void _CreateObjects(int Layer) {
  ...
  /* Create frame window */
  _hWin = FRAMEWIN_CreateEx(10, 10, xSize, ySize, WM_HBKWIN, WM_CF_SHOW | WM_CF_MEMDEV, FRAMEWIN_CF_MOVEABLE, 0, "Screen rotation sample", _cbWin);
