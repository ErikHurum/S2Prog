...
:START
REM ECHO CC.BAT:                   Compiling %1.c

REM CL /nologo /ML /W3 /O1 /Op /Oy /c /FoTemp\Output\ /D WIN32 /D _WINDOWS Temp\Source\%1.c>>NUL

CL /nologo /ML /W3 /O1 /Op /Oy /c /FoTemp\Output\ /D WIN32 /D _WINDOWS Temp\Source\%1.c
