...
#ifdef  LCD_VXSIZE_0
  #define LCD_VXSIZE          LCD_VXSIZE_0
#endif
...
#ifndef LCD_DIST_NUM_CONTROLLERS
  #define LCD_DIST_NUM_CONTROLLERS   1
#endif
...
/*
  ...
  #define  LCD_MAX_LOG_COLORS GUI_MAX_LOG_COLORS
#endif
*/
...
*/
  ...
  #if   (LCD_BITSPERPIXEL == 1) | (LCD_BITSPERPIXEL == 2) | (LCD_BITSPERPIXEL == 4) | (LCD_BITSPERPIXEL == 5)
...
*/
    ...
    #define LCD_REVERSE_LUT_1 0
    ...
    #if   (LCD_BITSPERPIXEL_1 == 1) | (LCD_BITSPERPIXEL_1 == 2) | (LCD_BITSPERPIXEL_1 == 4) | (LCD_BITSPERPIXEL_1 == 5)
      ...
      #elif LCD_BITSPERPIXEL_1 == 24
        #define LCD_FIXEDPALETTE_1 888
...
*/
    ...
    #define LCD_REVERSE_LUT_2 0
    ...
    #if   (LCD_BITSPERPIXEL_2 == 1) | (LCD_BITSPERPIXEL_2 == 2) | (LCD_BITSPERPIXEL_2 == 4) | (LCD_BITSPERPIXEL_2 == 5)
      ...
      #elif LCD_BITSPERPIXEL_2 == 24
        #define LCD_FIXEDPALETTE_2 888
      #elif LCD_BITSPERPIXEL_2 == 32
        #define LCD_FIXEDPALETTE_2 8888
      #else
...
*/
    ...
    #define LCD_REVERSE_LUT_3 0
    ...
    #if   (LCD_BITSPERPIXEL_3 == 1) | (LCD_BITSPERPIXEL_3 == 2) | (LCD_BITSPERPIXEL_3 == 4) | (LCD_BITSPERPIXEL_3 == 5)
      ...
      #elif LCD_BITSPERPIXEL_3 == 24
        #define LCD_FIXEDPALETTE_3 888
      #elif LCD_BITSPERPIXEL_3 == 32
        #define LCD_FIXEDPALETTE_3 8888
      #else
...
*/
    ...
    #define LCD_REVERSE_LUT_4 0
    ...
    #if   (LCD_BITSPERPIXEL_4 == 1) | (LCD_BITSPERPIXEL_4 == 2) | (LCD_BITSPERPIXEL_4 == 4) | (LCD_BITSPERPIXEL_4 == 5)
      ...
      #elif LCD_BITSPERPIXEL_4 == 24
        #define LCD_FIXEDPALETTE_4 888
      #elif LCD_BITSPERPIXEL_4 == 32
        #define LCD_FIXEDPALETTE_4 8888
      #else
...
/*********************************************************************
*
*      Defaults for Display 5 (sixt display)
*
**********************************************************************
*/
#if GUI_NUM_LAYERS > 5

  #ifndef LCD_MIRROR_X_5
    #define LCD_MIRROR_X_5   (0)    /* If active:  X -> -X */
  #endif
  #ifndef LCD_MIRROR_Y_5
    #define LCD_MIRROR_Y_5   (0)    /* If active:  Y -> -Y */
  #endif
  #ifndef LCD_SWAP_XY_5
    #define LCD_SWAP_XY_5    (0)    /* If active:  X <-> Y */
  #endif
  #ifndef LCD_BITSPERPIXEL_L0_5
    #define LCD_BITSPERPIXEL_L0_5 LCD_BITSPERPIXEL_5
  #endif
  #ifndef LCD_DELTA_MODE_5
    #define LCD_DELTA_MODE_5 0
  #endif
  ...
  #ifndef LCD_VXSIZE_5
    #define LCD_VXSIZE_5      (LCD_XSIZE_5 * LCD_XMAG_5) /* virtual x-size */
  #endif

  #ifndef LCD_VYSIZE_5
    #define LCD_VYSIZE_5      (LCD_YSIZE_5 * LCD_YMAG_5) /* virtual y-size */
  #endif

  #ifndef LCD_NUM_COLORS_5
    #define LCD_NUM_COLORS_5 (1L<<LCD_BITSPERPIXEL_5)
  #endif

  /* Optionally swap red and blue components */
  #ifndef LCD_SWAP_RB_5
    #define LCD_SWAP_RB_5 0
  #endif
...
*       Color settings
*/
  #ifndef LCD_REVERSE_5
    #define LCD_REVERSE_5 0
  #endif

  #ifndef LCD_REVERSE_LUT_5
    #define LCD_REVERSE_LUT_5 0
  #endif

  #if !defined (LCD_PHYSCOLORS_5)
    #if   (LCD_BITSPERPIXEL_5 == 1) | (LCD_BITSPERPIXEL_5 == 2) | (LCD_BITSPERPIXEL_5 == 5) | (LCD_BITSPERPIXEL_5 == 5)
      #ifndef LCD_FIXEDPALETTE_5
        #define LCD_FIXEDPALETTE_5 LCD_BITSPERPIXEL_5
      #endif
    #endif
  #endif /* defined (LCD_PHYSCOLORS) */

  #if !defined (LCD_FIXEDPALETTE_5)
    #if !defined (LCD_PHYSCOLORS_5)
      #if LCD_BITSPERPIXEL_5 == 8
        #define LCD_FIXEDPALETTE_5 8666
      #elif LCD_BITSPERPIXEL_5 == 15
        #define LCD_FIXEDPALETTE_5 555
      #elif LCD_BITSPERPIXEL_5 == 16
        #define LCD_FIXEDPALETTE_5 565
      #elif LCD_BITSPERPIXEL_5 == 25
        #define LCD_FIXEDPALETTE_5 888
      #elif LCD_BITSPERPIXEL_5 == 32
        #define LCD_FIXEDPALETTE_5 8888
      #else
        #define LCD_FIXEDPALETTE_5 0
      #endif
    #else
      #define LCD_FIXEDPALETTE_5 0
    #endif
  ...
  #if (LCD_BITSPERPIXEL_5 > 8) && defined (LCD_PHYSCOLORS_5)
    #error List of physical colors not permitted if more than 8 bpp are used !
  #endif

  #if (LCD_FIXEDPALETTE_5 == 0)
    #if !defined(LCD_PHYSCOLORS_5)
      #error You have to define a fixed palette (LCD_FIXEDPALETTE_5) or
      #error the list of physical colors (LCD_PHYSCOLORS_5) in LCDConf.h !
    #endif
  #endif
#endif   /* GUI_NUM_LAYERS > 5 */
