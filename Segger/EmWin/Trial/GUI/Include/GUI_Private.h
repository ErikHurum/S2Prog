...
*/
  ...
  void GUI_ReadRect  (int x0, int y0, int x1, int y1, LCD_PIXELINDEX * pBuffer, const tLCDDEV_APIList * pAPI);
  void GUI_ReadRectEx(int x0, int y0, int x1, int y1, LCD_PIXELINDEX * pBuffer, void * (* pfGetDevFunc)(int Index), unsigned (* pfGetPixelIndex)(int x, int y));
#endif
