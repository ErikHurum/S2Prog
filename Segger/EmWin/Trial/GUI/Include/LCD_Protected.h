...
#define DECLARE_L0_DATA(x) \
extern const LCD_LUT_INFO    LCD_L0##x##LutInfo; \
extern const tLCDDEV_APIList LCD_L0##x##APIList
...
#if (GUI_SUPPORT_CURSOR || GUI_SUPPORT_SPRITE)
...
I32                   LCD_L0##x##GetDevProp         (int Index);                             \
tLCDDEV_Index2Color * LCD_L0##x##GetpfIndex2Color   (void);                                  \
tLCDDEV_Color2Index * LCD_L0##x##GetpfColor2Index   (void);                                  \
