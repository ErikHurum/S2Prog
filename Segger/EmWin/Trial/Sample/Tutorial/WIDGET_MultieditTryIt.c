...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect,  "MultiEdit sample",        0,                   5,   5, 310, 230, FRAMEWIN_CF_MOVEABLE },
  ...
  case WM_NOTIFY_PARENT:
    ...
    case WM_NOTIFICATION_VALUE_CHANGED:
      ...
      case GUI_ID_SLIDER3:
        ...
        break;
      case GUI_ID_RADIO0:    /* Horizontal scrollbar */
        ...
        case 0:           /* Auto */
          ...
          break;
        case 1:           /* Off */
          MULTIEDIT_SetAutoScrollH(hMulti, 0);
        ...
        break;
      case GUI_ID_RADIO1:       /* Vertical scrollbar */
        Sel = RADIO_GetValue(hItem);
        switch (Sel) {
        case 0:
          MULTIEDIT_SetAutoScrollV(hMulti, 1);
      ...
      case GUI_ID_RADIO2:       /* Wrap */
        ...
        break;
      case GUI_ID_RADIO3:       /* Effect type */
        Sel = RADIO_GetValue(hItem);
        switch (Sel) {
        case 0:
