...
#define LEVELSWITCH_APPL        110
#define LEVELSWITCH_GROUP       111
#define MODBUS_DIGITAL_IN_APPL  112
#define MODBUS_DIGITAL_IN_GROUP 113

#define SCRATCH_APPL            150
#define SCRATCH_GROUP           151
