...
DWORD WINAPI MBTSwapDWord(const DWORD dwData);
	...
	typedef long (*mbtVoidFunc)(void);
	typedef long (*mbtConnectFunc)(LPCTSTR,WORD,BOOL,DWORD,HANDLE*);
	typedef long (*mbtDisconnectFunc)(HANDLE);
	typedef long (*mbtReadRegistersFunc)(HANDLE,BYTE,WORD,WORD,LPBYTE,MBTReadCompleted,DWORD);
	typedef long (*mbtWriteRegistersFunc)(HANDLE,WORD,WORD,LPBYTE,MBTWriteCompleted,DWORD);
	typedef long (*mbtReadCoilsFunc)(HANDLE,BYTE,WORD,WORD,LPBYTE,MBTReadCompleted,DWORD);
	typedef long (*mbtWriteCoilsFunc)(HANDLE,WORD,WORD,LPBYTE,MBTWriteCompleted,DWORD);
#endif
