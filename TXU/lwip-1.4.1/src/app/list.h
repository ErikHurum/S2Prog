////////////////////////////////////////////////////////////////////////////////////
//
// generic list library borrowed from list kernel source 
//
// *** NOTE ***
// freaking IAR compiler doesn't support typeof operator.
// so only some parts of the code, which are actually used, are ported to IAR
// -hkim-
//
////////////////////////////////////////////////////////////////////////////////////
#ifndef _LIST_H_
...
#define container_of(ptr, type, member) (type *)((char *)ptr - offsetof2(type,member))
...
#else
extern void __list_add(struct list_head *newe,
    struct list_head *prev,
    struct list_head *next);
#endif
 ...
 * @param head:	the head for your list.
 * @param member:	the name of the list_struct within the struct.
 * @param type : type of the structure. -hkim-
 */
