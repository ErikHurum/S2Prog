...
#ifndef __TFTP_SERVER_DEF_H__
#define __TFTP_SERVER_DEF_H__
...
typedef tTFTPError (*tTFTPRequest)(struct _tTFTPConnection*, bool, int8_t*, tTFTPMode);
typedef tTFTPError (*tTFTPTransfer)(struct _tTFTPConnection*);
typedef void (*tTFTPClose)(struct _tTFTPConnection*);
...
//
//*****************************************************************************
extern void TFTPServerInit(tTFTPRequest);
