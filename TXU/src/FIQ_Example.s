        ...
        EXPORT  os_irq_handler
os_irq_handler
        DCD     angel_IRQInterruptHandler2
        EXPORT  os_fiq_handler
os_fiq_handler
        DCD     angel_FIQInterruptHandler2
...
angel_FIQInterruptHandler
        stmfd   sp!, {r0}
        ldr     r0, =os_fiq_handler
        ldr     r0, [r0]
        swp     r0, r0, [sp]
        ldmfd   sp!, {pc}

angel_FIQInterruptHandler2
