...
// This constant should have been defined in RTOS.h, but to avoid surprises related to
// upgrades from Segger, the constant is defined here instead
#define OS_FSYS_180 180000000                   
#define OS_FSYS_202 202800000                   
#define OS_FSYS_220 220000000    
#define OS_FSYS_226 226000000
#define OS_FSYS_250 250000000                   
#define OS_FSYS_260 260000000
#define OS_FSYS_266 266000000
#define OS_FSYS_270 270000000
#ifdef __cplusplus
extern "C" {
#endif
...
#define BIT_SUB_EINT4   ( 1 << 4)
#define BIT_SUB_EINT5   ( 1 << 5)
#define BIT_SUB_EINT6   ( 1 << 6)
#define BIT_SUB_EINT7   ( 1 << 7)
#define BIT_SUB_EINT8   ( 1 << 8)
#define BIT_SUB_EINT9   ( 1 << 9)
#define BIT_SUB_EINT10  ( 1 << 10)
#define BIT_SUB_EINT11  ( 1 << 11)
#define BIT_SUB_EINT12  ( 1 << 12)
#define BIT_SUB_EINT13  ( 1 << 13)
#define BIT_SUB_EINT14  ( 1 << 14)
#define BIT_SUB_EINT15  ( 1 << 15)
#define BIT_SUB_EINT16  ( 1 << 16)
#define BIT_SUB_EINT17  ( 1 << 17)
// Added by EHS
#define INTOFF_TIMER0   10  /* timer 0 interrupt                */
#define INTOFF_TIMER1   11  /* timer 1 interrupt                */
#define INTOFF_TIMER2   12  /* timer 2 interrupt                */
#define INTOFF_TIMER3   13  /* timer 3 interrupt                */
#define INTOFF_TIMER4   14  /* timer 4 interrupt                */
#define INTOFF_UART0    28  /* UART0 interrupt                  */
#define INTOFF_UART1    23  /* UART1 interrupt                  */
#define INTOFF_UART2    15  /* UART2 interrupt                  */
#define INTOFF_LCD      16  /* LCD interrupt                    */
#define INTOFF_ADC      31  /* AD interrupt                 */
#define INTOFF_4_7      4
#define INTOFF_8_23     5

    
#define INTOFF_SILENCE      4
#define INTOFF_IC1_UP       5
#define INTOFF_IC1_DOWN     6
#define INTOFF_IC2_UP       7
#define INTOFF_IC2_DOWN     8
#define INTOFF_CS8900       16
    
#define INTOFF_INC1_DOWN
#define INTOFF_INC2_UP
#define INTOFF_INC2_DOWN

#define INTOFF_UART_A   00
#define INTOFF_UART_B   01
#define INTOFF_UART_C   02
#define INTOFF_UART_D   03


#define ClearPending(bit) {\
                rSRCPND = (unsigned)bit;\
                rINTPND = (unsigned)bit;\
                rINTPND;\
                }
