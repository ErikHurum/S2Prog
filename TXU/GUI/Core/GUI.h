...
*/
typedef int GET_DATA_FUNC(void * p, int NumBytes, const U8 ** ppData, unsigned StartOfFile);
...
typedef GET_DATA_FUNC GUI_GIF_GET_DATA_FUNC;
...
int GUI_GIF_DrawSubScaledEx(GUI_GIF_GET_DATA_FUNC * fpGetData, void * p, int x0, int y0, int Index, int Num, int Denom);
...
typedef GET_DATA_FUNC GUI_BMP_GET_DATA_FUNC;

int GUI_BMP_Draw        (const void * pFileData,                      int x0, int y0);
int GUI_BMP_DrawEx      (GUI_BMP_GET_DATA_FUNC * fpGetData, void * p, int x0, int y0);
int GUI_BMP_DrawScaled  (const void * pFileData,                      int x0, int y0, int Num, int Denom);
int GUI_BMP_DrawScaledEx(GUI_BMP_GET_DATA_FUNC * fpGetData, void * p, int x0, int y0, int Num, int Denom);
...
typedef GET_DATA_FUNC GUI_JPEG_GET_DATA_FUNC;
...
#define GUI_JPEG_DrawEx(      fpGetData, p, x0, y0)                    GUI_JPEG1_DrawEx      (fpGetData, p, x0, y0)                   
#define GUI_JPEG_DrawScaledEx(fpGetData, p, x0, y0, Num, Denom)        GUI_JPEG1_DrawScaledEx(fpGetData, p, x0, y0, Num, Denom)       
#define GUI_JPEG_GetInfoEx(   fpGetData, p, pInfo)                     GUI_JPEG1_GetInfoEx   (fpGetData, p, pInfo)                    
...
int GUI_JPEG1_DrawEx      (GUI_JPEG_GET_DATA_FUNC * pfGetData, void * p, int x0, int y0);
int GUI_JPEG1_DrawScaled  (const void * pFileData, int DataSize,         int x0, int y0, int Num, int Denom);
int GUI_JPEG1_DrawScaledEx(GUI_JPEG_GET_DATA_FUNC * fpGetData, void * p, int x0, int y0, int Num, int Denom);
int GUI_JPEG1_GetInfo     (const void * pFileData, int DataSize,         GUI_JPEG_INFO * pContext);
int GUI_JPEG1_GetInfoEx   (GUI_JPEG_GET_DATA_FUNC * pfGetData, void * p, GUI_JPEG_INFO * pContext);
