...
const tLCDDEV_APIList LCD_L0_APIList = {
    ...
    LCD_L0_Index2Color,
    LCD_L0_GetIndexMask,
    (tLCDDEV_DrawBitmap*)LCD_L0_DELTA_DrawBitmap,
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
...
const tLCDDEV_APIList LCD_L0_1_APIList = {
  ...
  LCD_L0_1_Index2Color,
  LCD_L0_1_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_1_MAG_DrawBitmap,
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL_1 == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
      &GUI_MEMDEV__APIList1
    #else
      &GUI_MEMDEV__APIList8
    #endif
...
const tLCDDEV_APIList LCD_L0_2_APIList = {
  ...
  (tLCDDEV_DrawBitmap*)LCD_L0_2_DrawBitmap,
  LCD_L0_2_DrawHLine,
  LCD_L0_2_DrawVLine,
  LCD_L0_2_FillRect,
  ...
  LCD_L0_2_Index2Color,
  LCD_L0_2_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_2_MAG_DrawBitmap,
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL_2 == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
      &GUI_MEMDEV__APIList1
    #else
      &GUI_MEMDEV__APIList8
    #endif
...
const tLCDDEV_APIList LCD_L0_3_APIList = {
  ...
  (tLCDDEV_DrawBitmap*)LCD_L0_3_DrawBitmap,
  LCD_L0_3_DrawHLine,
  LCD_L0_3_DrawVLine,
  LCD_L0_3_FillRect,
  ...
  LCD_L0_3_Index2Color,
  LCD_L0_3_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_3_MAG_DrawBitmap,
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL_3 == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
      &GUI_MEMDEV__APIList1
    #else
      &GUI_MEMDEV__APIList8
    #endif
...
const tLCDDEV_APIList LCD_L0_4_APIList = {
  ...
  (tLCDDEV_DrawBitmap*)LCD_L0_4_DrawBitmap,
  LCD_L0_4_DrawHLine,
  LCD_L0_4_DrawVLine,
  LCD_L0_4_FillRect,
  ...
  LCD_L0_4_Index2Color,
  LCD_L0_4_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_4_MAG_DrawBitmap,
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL_4 == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
      &GUI_MEMDEV__APIList1
    #else
      &GUI_MEMDEV__APIList8
    #endif
...
#if GUI_NUM_LAYERS > 5
const tLCDDEV_APIList LCD_L0_5_APIList = {
#if LCD_YMAG_5 == 1
  LCD_L0_5_Color2Index,
  LCD_L0_5_Index2Color,
  LCD_L0_5_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_5_DrawBitmap,
  LCD_L0_5_DrawHLine,
  LCD_L0_5_DrawVLine,
  LCD_L0_5_FillRect,
  LCD_L0_5_GetPixelIndex,
  LCD_L0_5_GetRect,
  LCD_L0_5_SetPixelIndex,
  LCD_L0_5_XorPixel,
  ...
  LCD_L0_5_Index2Color,
  LCD_L0_5_GetIndexMask,
  (tLCDDEV_DrawBitmap*)LCD_L0_5_MAG_DrawBitmap,
  LCD_L0_5_MAG_DrawHLine,
  LCD_L0_5_MAG_DrawVLine,
  LCD_L0_5_MAG_FillRect,
  LCD_L0_5_MAG_GetPixelIndex,
  LCD_L0_5_GetRect,          /* Original routine is o.k. here, since we use the logical
                                 coordinates for clipping, which are not magnified */
  LCD_L0_5_MAG_SetPixelIndex,
  LCD_L0_5_MAG_XorPixel,
  LCD_L0_5_SetLUTEntry,
  LCD_L0_5_GetDevFunc,
#endif
#if GUI_SUPPORT_MEMDEV
  ...
  NULL,                       /* pfFillPolygonAA */
    ...
    #if (LCD_BITSPERPIXEL_5 == 1) && (GUI_USE_MEMDEV_1BPP_FOR_SCREEN == 1)
      &GUI_MEMDEV__APIList1
    #else
      &GUI_MEMDEV__APIList8
    #endif
