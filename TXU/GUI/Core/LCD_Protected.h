...
unsigned LCD_Color2Index_User_0  (LCD_COLOR Color);
unsigned LCD_Color2Index_User_1  (LCD_COLOR Color);
unsigned LCD_Color2Index_User_2  (LCD_COLOR Color);
unsigned LCD_Color2Index_User_3  (LCD_COLOR Color);
unsigned LCD_Color2Index_User_4  (LCD_COLOR Color);
unsigned LCD_Color2Index_User_5  (LCD_COLOR Color);

LCD_COLOR LCD_Index2Color_User_0  (int Index);
LCD_COLOR LCD_Index2Color_User_1  (int Index);
LCD_COLOR LCD_Index2Color_User_2  (int Index);
LCD_COLOR LCD_Index2Color_User_3  (int Index);
LCD_COLOR LCD_Index2Color_User_4  (int Index);
LCD_COLOR LCD_Index2Color_User_5  (int Index);

unsigned LCD_GetIndexMask_User_0  (void);
unsigned LCD_GetIndexMask_User_1  (void);
unsigned LCD_GetIndexMask_User_2  (void);
unsigned LCD_GetIndexMask_User_3  (void);
unsigned LCD_GetIndexMask_User_4  (void);
unsigned LCD_GetIndexMask_User_5  (void);
