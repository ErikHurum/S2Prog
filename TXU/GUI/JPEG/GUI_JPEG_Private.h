...
#define MAX_BLOCKSPERROW 1000 /* Should be enougth for xSize up to 2000 pixels */
...
/* Decompression context, sizeof(GUI_JPEG_DCONTEXT) is app. 38968 bytes */
...
struct GUI_JPEG_DCONTEXT {
  ...
  /* Block buffer */
  GUI_HMEM ahBlocks[MAX_BLOCKSPERROW];
  U8 aBlockMaxZagSet[MAX_BLOCKSPERROW];
  /* Sample buffer */
  GUI_HMEM hSampleBuf;
  U8     * pSampleBuf;
  /* Status */
...
**********************************************************************
*/
extern GUI_JPEG_DCONTEXT GUI_JPEG__DContext;
