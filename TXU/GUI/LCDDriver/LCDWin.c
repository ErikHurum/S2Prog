...
1.30    000309 RS     a) Interface change for GUI V1.30
...
*    Sets the layer size
*/
static void _SetSize(int w, int h) {
  GUI_USE_PARA(w);
  GUI_USE_PARA(h);
}
...
*/
static void _SetAlpha(int Alpha) {
#ifndef WIN32
  LCDSIM_SetAlpha(Alpha, LCD_DISPLAY_INDEX);
#endif
}
