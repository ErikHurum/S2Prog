...
#define SetBitsOr( SFR, MASK ) OS_IncDI(); (SFR) |=  (MASK); OS_DecRI()                                     // enable int
...
#define XTAL_CPU      4096000L // 16000000L     // Frequency of CPU Xtal
#else
#define XTAL_CPU      4096000L     // Frequency 4MHz minimum
#endif

#define RS485UART0  (0x1100 + 0x08)         // Address to uart0
#define RS485UART1  0x1100                  // Address to uart1
...
#define AN_ZBHART       0x03            // Unit ID for AN-ZBANA
#define AN_SGCNV        0x04            // Unit ID for AN-ZBANA
 
#define PI              3.141592654
#define RAD_FACTOR      (180/PI)       // 57.29577951

#define ADCLK             0x10          // PORTD bit 4 for AD clock
#define ADCDO             0x04          // PORTG bit 2 for AD out
#define ADCDI             0x08          // PORTG bit 3 for AD in
...
// Constants from original AN-SGCNV code

#define AD_SET_TIME			67    /* Settling time for ad, 67ms */
#define OHM_1K			0x08		/* port E bit 3 1 K OHM RESISTOR */
#define OHM_1R			0x10		/* port E bit 4, 1 OHM RESISTOR */


#define LED2			0x02	   // STATUSLED2 0 = ON */
#define LED1			0x20	   // STATUSLED1 0=ON */
