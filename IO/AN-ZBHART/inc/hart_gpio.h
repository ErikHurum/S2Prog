...
extern void hart_gpio_enable_all_mux(void);
extern void hart_gpio_adc_channel_select(hart_channel_t chnl);
extern void hart_gpio_adc_reset(uint8_t hi);
extern void hart_gpio_hart_carrier_on(hart_modem_t modem);
extern void hart_gpio_hart_carrier_on_irq(hart_modem_t modem);
extern void hart_gpio_hart_carrier_off(hart_modem_t modem);
extern void hart_gpio_hart_carrier_off_irq(hart_modem_t modem);
