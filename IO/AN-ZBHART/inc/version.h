...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 ...
 V 9
    - updated OS
    - corrected various stack sizes and added more security to various loops to ensure exit and not
        exceeding buffer sizes
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 V 8
      - Corrected stacks, CPU load, exit counter for various loops
      - Corrected bug related to incorrect use of rx/tx address. Also corrected RX interupt handling for all My485UARTs
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  V 28                       Released: 14-oct-09
      - Uses external bus to My485UART(ADcard com) (ExiInt.c, RS485.c)
 ...
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  V 25                       Released: 12-aug-09
      - Changed to while loop to avoid missing characters in CPU My485UART (UsartInt.c)
 ...
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  V 16                        Released: 18-nov-04
      ...
      - Add counter (16) in 16552 My485UART loop for exit
  ...
  V 4                        Released: 17-Mar-04
      - Use My_SetBit / My_ClrBit with dissabling interrupt
