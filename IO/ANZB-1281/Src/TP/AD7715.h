...
typedef union
{
    struct
    {
        unsigned char  Gain        :2;  /*!< bits 1:0   : Gain Select */
        unsigned char  STBY        :1;  /*!< bit  2     : Standby */
        unsigned char  RW          :1;  /*!< bit  3     : Read/Write Select */
        unsigned char  RS          :2;  /*!< bits 5:4   : Register Selection */ 
        unsigned char  Zero        :1;  /*!< bit  6       : must be zero! */
        unsigned char  DRDY        :1;  /*!< bit  7       : DRDY bit */
    } b;
    unsigned char  B;
} AD7715_CommReg_t;
...
typedef union
{
    struct
    {
        unsigned char  FSYNC        :1;          /*!< bit  0       : filter synchronization */
        unsigned char  BUF        :1;          /*!< bit  1       : buffer control */
        unsigned char  BU            :1;            /*!< bit  2     : bipolar/unipolar  */
		unsigned char  FS			:2;			/*!< bits 4:3   : output update rate */ 
		unsigned char  CLK		  :1;			/*!< bit  5     : master clock selection */
		unsigned char  MD 		  :2;			/*!< bits 7:6   : Mode select */
	} b;
	unsigned char  B;
} AD7715_SetupReg_t;
