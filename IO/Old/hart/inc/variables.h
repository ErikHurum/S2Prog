...
UARTDataType    UART[1];                    // set ut Uart struct for two CPU ports
...
char MailBufCh0[MBUF_SIZE];
//ADC Int
volatile char  ADChannel = 0;                            // AD channel to be converted
...
// uart 0
volatile char hostAddress ;                         // host address
