...
#define MAX_QUERY_LENGTH        512 // For safety, protocol defines 255 as maximum
#define MAX_RESPONSE_LENGTH     1024
#define MAX_REGISTERS_RTU_COM   0x7D    // Ref Modbu.org "Modbus Application Protocol 1 1 b3 Page 15
#define MAX_REGISTERS_RTU_TCP   0x7B    // Ref Modbu.org "Modbus Application Protocol 1 1 b3 Page 30
#define MAX_COILS_RTU_COM       0x7D0   // Ref Modbu.org "Modbus Application Protocol 1 1 b3 Page 11
#define MAX_COILS_RTU_TCP       0x7B0   // Ref Modbu.org "Modbus Application Protocol 1 1 b3 Page 29
...
#define MBUS_REQUEST_DELAY      2000
...
#define MB_GetBit(a, b)                ((((U8*)a)[(b)>>3] >> ((b)&7)) & 1)
// set bit Boolean value to 1
#define MB_SetBit(a, b)                (((U8*)a)[(b)>>3] |= (1 << ((b)&7)))
// set bit Boolean value to 0
#define MB_ResetBit(a, b)              (((U8*)a)[(b)>>3] &= ~(1 << ((b)&7)))
// toggle bit Boolean value
#define MB_XOrBit(a, b)                (((U8*)a)[(b)>>3] ^= (1 << ((b)&7)))
