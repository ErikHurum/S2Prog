...
ModbusWago482RegisterIn::ModbusWago482RegisterIn(bool pIsCreatedFromMultiple):ModbusRegisterIn(pIsCreatedFromMultiple, C_PRO_MBUS_WAGO482_RIN)
{
    RegMax            = 0x7fff;
    MinRange          = -10.0;
    MaxRange          =  10.0;
...
ModbusWago482RegisterIn::~ModbusWago482RegisterIn()
{
}
...
//
///////////////////////////////////////////////////////////////
AnsiString ModbusWago482RegisterIn::MakeConfigString(int ExtraTabs)
{
...
void ModbusWago482RegisterIn::Update(void)
{
...
AnsiString ModbusWago482RegisterIn::GetRegisterType(void)
{
    return "Wago 750-482";
}
