...
//Value types for communication to i.e TPC Range: 5000 -> 5999
   ...
   // {  "VT_TT"                  , SVT_TT                      + C_SVT_OFFSET },
    ...
    {  "VT_HART_TEMPERATURE"    , SVT_HART_TEMPERATURE          + C_SVT_OFFSET },
    ...
    {  "VT_Cargo_Volume"        , SVT_CARGO_VOLUME          + C_SVT_OFFSET },
    {  "VT_Cargo_Weight"        , SVT_CARGO_WEIGHT          + C_SVT_OFFSET },
    {  "VT_Ballast_Volume"      , SVT_BALLAST_VOLUME        + C_SVT_OFFSET },
    {  "VT_Ballast_Weight"      , SVT_BALLAST_WEIGHT        + C_SVT_OFFSET },
    {  "VT_HeavyFuel_Volume"    , SVT_HEAVY_FUEL_VOLUME     + C_SVT_OFFSET },
    {  "VT_HeavyFuel_Weight"    , SVT_HEAVY_FUEL_WEIGHT     + C_SVT_OFFSET },
    {  "VT_Diesel_Volume"       , SVT_DIESEL_OIL_VOLUME     + C_SVT_OFFSET },
    {  "VT_Diesel_Weight"       , SVT_DIESEL_OIL_WEIGHT     + C_SVT_OFFSET },
    {  "VT_Lubricants_Volume"   , SVT_LUBRICANTS_VOLUME     + C_SVT_OFFSET },
    {  "VT_Lubricants_Weight"   , SVT_LUBRICANTS_WEIGHT     + C_SVT_OFFSET },
    {  "VT_FreshWater_Volume"   , SVT_FRESH_WATER_VOLUME    + C_SVT_OFFSET },
    {  "VT_FreshWater_Weight"   , SVT_FRESH_WATER_WEIGHT    + C_SVT_OFFSET },
    {  "VT_Misc_Volume"         , SVT_MISC_VOLUME           + C_SVT_OFFSET },
    {  "VT_Misc_Weight"         , SVT_MISC_WEIGHT           + C_SVT_OFFSET },
    {  "VT_VoidSpace_Volume"    , SVT_VOID_SPACE_WEIGHT     + C_SVT_OFFSET },
    {  "VT_VoidSpace_Weight"    , SVT_VOID_SPACE_VOLUME     + C_SVT_OFFSET },
