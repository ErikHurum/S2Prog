...
IMPLEMENT_DYNAMIC(CServiceOtherDlgPR, COperationDlg)

CServiceOtherDlgPR::CServiceOtherDlgPR()
{
...
BEGIN_MESSAGE_MAP(CServiceOtherDlgPR, COperationDlg)
	ON_BN_CLICKED(IDC_BUTTON_LOAD, &CServiceOtherDlgPR::OnBnClickedButtonLoad)
	ON_BN_CLICKED(IDC_BUTTON_SAVE, &CServiceOtherDlgPR::OnBnClickedButtonSave)
END_MESSAGE_MAP()

void CServiceOtherDlgPR::LoadData()
{
	CProgress progress;
	UINT8 intData;
...
void CServiceOtherDlgPR::SaveData()
{
	int intData;
...
// CServiceOtherDlgPR 消息处理程序



void CServiceOtherDlgPR::DoDataExchange(CDataExchange* pDX)
{
...
void CServiceOtherDlgPR::OnBnClickedButtonLoad()
{
...
void CServiceOtherDlgPR::OnBnClickedButtonSave()
{
