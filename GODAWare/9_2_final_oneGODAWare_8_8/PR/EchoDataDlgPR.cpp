...
IMPLEMENT_DYNAMIC(CEchoDataDlgPR, CCustomDialogEx)

CEchoDataDlgPR::CEchoDataDlgPR()
{
...
BEGIN_MESSAGE_MAP(CEchoDataDlgPR, CCustomDialogEx)
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BTN_LOAD, &CEchoDataDlgPR::OnBnClickedBtnLoad)
END_MESSAGE_MAP()



// CEchoDataDlgPR 消息处理程序



void CEchoDataDlgPR::DoDataExchange(CDataExchange* pDX)
{
...
BOOL CEchoDataDlgPR::OnInitDialog()
{
...
void CEchoDataDlgPR::OnSize(UINT nType, int cx, int cy)
{
...
void CEchoDataDlgPR::OnBnClickedBtnLoad()
{
	CProgress progress;
