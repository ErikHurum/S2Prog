...
IMPLEMENT_DYNAMIC(CLinearizationDlgPR, COperationDlg)

CLinearizationDlgPR::CLinearizationDlgPR()
{
...
BEGIN_MESSAGE_MAP(CLinearizationDlgPR, COperationDlg)
	ON_BN_CLICKED(IDC_BUTTON_EDIT, &CLinearizationDlgPR::OnBnClickedButtonEdit)
	ON_CBN_SELCHANGE(IDC_COMBO_LIN0EARIZATIONTYPE, &CLinearizationDlgPR::OnCbnSelchangeComboLinearizationtype)
	ON_CBN_SELCHANGE(IDC_COMBO_VESSELTYPE, &CLinearizationDlgPR::OnCbnSelchangeComboVesseltype)
END_MESSAGE_MAP()

void CLinearizationDlgPR::LoadData()
{
	CProgress progress;
	CString str;
	UINT8 intData;
...
void CLinearizationDlgPR::SaveData()
{
	CProgress progress;
	CString str;
	int intData;
...
// CLinearizationDlgPR 消息处理程序



void CLinearizationDlgPR::DoDataExchange(CDataExchange* pDX)
{
...
void CLinearizationDlgPR::OnBnClickedButtonEdit()
{
...
void CLinearizationDlgPR::OnCbnSelchangeComboLinearizationtype()
{
	int nType;
...
void CLinearizationDlgPR::OnCbnSelchangeComboVesseltype()
{
