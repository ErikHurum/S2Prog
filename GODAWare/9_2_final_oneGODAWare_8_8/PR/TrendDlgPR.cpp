...
IMPLEMENT_DYNAMIC(CTrendDlgPR, CCustomDialogEx)

CTrendDlgPR::CTrendDlgPR()
{
...
BEGIN_MESSAGE_MAP(CTrendDlgPR, CCustomDialogEx)
	ON_BN_CLICKED(IDC_BTN_LOAD, &CTrendDlgPR::OnBnClickedBtnLoad)
	ON_WM_SIZE()
END_MESSAGE_MAP()
...
void CTrendDlgPR::OnBnClickedBtnLoad()
{
...
void CTrendDlgPR::OnSize(UINT nType, int cx, int cy)
{
...
void CTrendDlgPR::DoDataExchange(CDataExchange* pDX)
{
