...
IMPLEMENT_DYNAMIC(COutputMappingDlgPR, CCustomDialogEx)

COutputMappingDlgPR::COutputMappingDlgPR()
{
...
BEGIN_MESSAGE_MAP(COutputMappingDlgPR, CCustomDialogEx)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BTN_LOAD, &COutputMappingDlgPR::OnBnClickedBtnLoad)
END_MESSAGE_MAP()


// COutputMappingDlgPR 消息处理程序



int COutputMappingDlgPR::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void COutputMappingDlgPR::OnSize(UINT nType, int cx, int cy)
{
...
void COutputMappingDlgPR::DoDataExchange( CDataExchange* pDX )
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_LIST_MAPPING, m_mapping);
}
BOOL COutputMappingDlgPR::OnInitDialog()
{
...
void COutputMappingDlgPR::OnBnClickedBtnLoad()
{
