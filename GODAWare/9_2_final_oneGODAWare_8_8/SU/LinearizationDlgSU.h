...
class CLinearizationDlgSU : public COperationDlg
{
	DECLARE_DYNAMIC(CLinearizationDlgSU)

public:
	CLinearizationDlgSU();
	virtual ~CLinearizationDlgSU();

	enum {IDD = IDD_LINEARIZATION_SU};
...
public:
	...
	afx_msg void OnStnClickedLabel13();
};
