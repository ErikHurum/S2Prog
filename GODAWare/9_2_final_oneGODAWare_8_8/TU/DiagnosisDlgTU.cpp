...
IMPLEMENT_DYNAMIC(CDiagnosisDlgTU, COperationDlg)

CDiagnosisDlgTU::CDiagnosisDlgTU()
{
	CString str;
...
BEGIN_MESSAGE_MAP(CDiagnosisDlgTU, COperationDlg)
END_MESSAGE_MAP()

void CDiagnosisDlgTU::LoadData()
{
	CProgress progress;
	CString str;
	float floatData;
...
// CDiagnosisDlgTU 消息处理程序



void CDiagnosisDlgTU::DoDataExchange(CDataExchange* pDX)
{
