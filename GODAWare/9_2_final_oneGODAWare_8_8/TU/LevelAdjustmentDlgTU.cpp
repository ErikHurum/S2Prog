...
IMPLEMENT_DYNAMIC(CLevelAdjustmentDlgTU, COperationDlg)

CLevelAdjustmentDlgTU::CLevelAdjustmentDlgTU()
{
...
void CLevelAdjustmentDlgTU::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLevelAdjustmentDlgTU, COperationDlg)
END_MESSAGE_MAP()


void CLevelAdjustmentDlgTU::LoadData()
{
	CProgress progress;
	float dbData;
	CString str;
...
void CLevelAdjustmentDlgTU::SaveData()
{
	CProgress progress;
	double dbData;
	CString str;
