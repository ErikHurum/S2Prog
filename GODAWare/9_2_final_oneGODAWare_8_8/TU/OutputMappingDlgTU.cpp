...
IMPLEMENT_DYNAMIC(COutputMappingDlgTU, CCustomDialogEx)

COutputMappingDlgTU::COutputMappingDlgTU()
{
...
BEGIN_MESSAGE_MAP(COutputMappingDlgTU, CCustomDialogEx)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BTN_LOAD, &COutputMappingDlgTU::OnBnClickedBtnLoad)
END_MESSAGE_MAP()


// COutputMappingDlgTU 消息处理程序



int COutputMappingDlgTU::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void COutputMappingDlgTU::OnSize(UINT nType, int cx, int cy)
{
...
void COutputMappingDlgTU::DoDataExchange( CDataExchange* pDX )
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_LIST_MAPPING, m_mapping);
}
BOOL COutputMappingDlgTU::OnInitDialog()
{
...
void COutputMappingDlgTU::OnBnClickedBtnLoad()
{
