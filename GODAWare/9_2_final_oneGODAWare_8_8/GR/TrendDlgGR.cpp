...
IMPLEMENT_DYNAMIC(CTrendDlgGR, CCustomDialogEx)

CTrendDlgGR::CTrendDlgGR()
{
...
BEGIN_MESSAGE_MAP(CTrendDlgGR, CCustomDialogEx)
	ON_BN_CLICKED(IDC_BTN_LOAD, &CTrendDlgGR::OnBnClickedBtnLoad)
	ON_WM_SIZE()
END_MESSAGE_MAP()
...
void CTrendDlgGR::OnBnClickedBtnLoad()
{
...
void CTrendDlgGR::OnSize(UINT nType, int cx, int cy)
{
...
void CTrendDlgGR::DoDataExchange(CDataExchange* pDX)
{
