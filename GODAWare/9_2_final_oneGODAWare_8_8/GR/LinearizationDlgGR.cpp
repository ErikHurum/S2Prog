...
IMPLEMENT_DYNAMIC(CLinearizationDlgGR, COperationDlg)

CLinearizationDlgGR::CLinearizationDlgGR()
{
...
BEGIN_MESSAGE_MAP(CLinearizationDlgGR, COperationDlg)
	ON_BN_CLICKED(IDC_BUTTON_EDIT, &CLinearizationDlgGR::OnBnClickedButtonEdit)
	ON_CBN_SELCHANGE(IDC_COMBO_LIN0EARIZATIONTYPE, &CLinearizationDlgGR::OnCbnSelchangeComboLinearizationtype)
	ON_CBN_SELCHANGE(IDC_COMBO_VESSELTYPE, &CLinearizationDlgGR::OnCbnSelchangeComboVesseltype)
END_MESSAGE_MAP()

void CLinearizationDlgGR::LoadData()
{
	CProgress progress;
	CString str;
	UINT8 intData;
...
void CLinearizationDlgGR::SaveData()
{
	CProgress progress;
	CString str;
	int intData;
...
// CLinearizationDlgGR 消息处理程序



void CLinearizationDlgGR::DoDataExchange(CDataExchange* pDX)
{
...
void CLinearizationDlgGR::OnBnClickedButtonEdit()
{
...
void CLinearizationDlgGR::OnCbnSelchangeComboLinearizationtype()
{
	int nType;
...
void CLinearizationDlgGR::OnCbnSelchangeComboVesseltype()
{
