...
IMPLEMENT_DYNAMIC(CDiagnosisDlgGR, COperationDlg)

CDiagnosisDlgGR::CDiagnosisDlgGR()
{
	CString str;
...
BEGIN_MESSAGE_MAP(CDiagnosisDlgGR, COperationDlg)
END_MESSAGE_MAP()

void CDiagnosisDlgGR::LoadData()
{
	CProgress progress;
	CString str;
	float floatData;
...
// CDiagnosisDlgGR 消息处理程序



void CDiagnosisDlgGR::DoDataExchange(CDataExchange* pDX)
{
